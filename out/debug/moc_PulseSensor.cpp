...
Q_CONSTINIT static const qt_meta_stringdata_PulseSensor_t qt_meta_stringdata_PulseSensor = {
    {
        ...
        QT_MOC_LITERAL(48, 21),  // "std::optional<Sample>"
        QT_MOC_LITERAL(70, 6),  // "sample"
        QT_MOC_LITERAL(77, 5),  // "start"
        QT_MOC_LITERAL(83, 4),  // "stop"
        QT_MOC_LITERAL(88, 8)   // "on_timer"
    },
    "PulseSensor",
    "sampled",
    "",
...
Q_CONSTINIT const QMetaObject PulseSensor::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_PulseSensor_t,
        ...
        QtPrivate::TypeAndForceComplete<std::optional<Sample>, std::false_type>,
        // method 'start'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'stop'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void PulseSensor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->sampled((*reinterpret_cast< std::add_pointer_t<PulseSensor::Status>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<std::optional<Sample>>>(_a[2]))); break;
        ...
        {
            using _t = void (PulseSensor::*)(PulseSensor::Status , std::optional<Sample> );
...
// SIGNAL 0
void PulseSensor::sampled(PulseSensor::Status _t1, std::optional<Sample> _t2)
{
